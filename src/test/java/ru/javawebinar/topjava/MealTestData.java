...
public class MealTestData<T> {
    ...
    public static final List<MealTo> MEALS_TO = MealsUtil.getTos(MEALS, MealsUtil.DEFAULT_CALORIES_PER_DAY);

    public static final List<MealTo> MEALS_TO_FILTERED = MealsUtil.getTos(List.of(MEAL3, MEAL2, MEAL1), MealsUtil.DEFAULT_CALORIES_PER_DAY);
